class script(object):
    START_TXT = """<b>ʜᴇʟʟᴏ {} 👋 🍿 I am a movie bot and I can give you all the movies you want But if you search for a movie without spelling mistakes, you will get the movie Thanks
𝗗𝗲𝘃𝗲𝗹𝗼𝗽𝗲𝗿 : @TBM_Admin</b>..."""
    HELP_TXT = """𝙷𝙴𝚈 {}
